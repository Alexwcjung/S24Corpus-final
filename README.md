...
### 1. Introduction
A solid understanding of English grammar enhances learners' accuracy in using English as a second language (L2). A common challenge for learners of English as a foreign language (EFL) is mastering the passive construction. Learners from different first language (L1) backgrounds often find English passives complex (Loan, 2019). Those whose L1 lacks the passive voice struggle more with English passives (Cowan, 2008). Even learners with some passive forms in their L1 face difficulties. For instance, L1-Thai speakers, whose native language mainly uses passives negatively, often make errors with English passive constructions (Simargool, 2008).
Alongside the 'be-passive' (be + past participle), the 'get-passive' (get + past participle) is also widely used in spoken English (Leech, Hundt, Mair, & Smith, 2009). Numerous corpus-based studies highlight the prevalence of get-passives across various English dialects (e.g., Carter & McCarthy, 1999; Mair, 2006). Granger (1983) compared the use of 'get-passives' between British and American English, noting that they are less common in British English, while 'be-passives' are more frequent than 'get-passives' in both dialects. Additionally, Weiner and Labov (1983) found that the use of 'get-passives' is increasing among American English speakers.
This article investigates the distribution of the English 'get-passive' compared to the 'be-passive.' A corpus study is used to find out the frequency of ‘get-passive’ and ‘be-passive’ in written and spoken texts respectively. The findings and implications of this study provide valuable insights for teaching 'get-passives' in the English as a Foreign Language (EFL) context.
...
![image]([Corpus/Table 1.png](https://raw.githubusercontent.com/Alexwcjung/S24Corpus-final/main/Corpus/Table%201.png))
![image]([https://github.com/Alexwcjung/EPA23/assets/127401494/fbfe9583-fce5-412b-a1bb-542eb3018550](https://raw.githubusercontent.com/Alexwcjung/S24Corpus-final/main/Corpus/Table%201.png))
